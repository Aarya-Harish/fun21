    ...
    try:
        ...
        if not result:
            ...
            user = User(
                ...
                performance_score=result.performance_score or 0,
                total_credits_earned=result.total_credits_earned or 0,
                ...
                is_oauth_user=result.is_oauth_user or False,
                verification_code=result.verification_code,
                verification_expires=result.verification_expires,
