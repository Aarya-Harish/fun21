...
import DynamicFeatureShowcase from '../components/DynamicFeatureShowcase';
...
const LoginPage: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Dynamic Feature Showcase - Left Side */}
      <Box
        sx={{
          position: 'fixed',
          top: 0,
      ...
      >
        ...
        >
          ...
          >
            ...
            <Typography component="h2" variant="h5" gutterBottom sx={{ mt: 2, color: '#1976d2', fontWeight: 'bold' }}>
              Welcome Back
            </Typography>
            <Typography variant="body2" textAlign="center" sx={{ mb: 3, color: '#666', fontWeight: '500' }}>
